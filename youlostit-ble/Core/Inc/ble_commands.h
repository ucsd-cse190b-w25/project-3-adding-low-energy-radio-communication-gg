 ...
 * */
 ...
 uint8_t DISCONNECT[] = {0x01,        // this is a command
                         0x06, 0x04,  // opcode
                         0x03,        // parameter length
                         0x00, 0x00,  // supplied in ble.c::disconnectBLE
                         0x00         // supplied in ble.c::disconnectBLE
                        };
 ...
 uint8_t ACI_GAP_SET_NON_DISCOVERABLE[] = {0x01, 0x81, 0xFC, 0x00}; // command, opcode 0xFC81, no parameters
 uint8_t ACI_GAP_SET_NON_DISCOVERABLE_COMPLETE[] = {0x04,       // event
                                                    0x0E,       // Command Complete
                                                    0x04,       // 4 parameters
                                                    0x01,       
                                                    0x81, 0xFC, // original opcode
                                                    0x00        // success
                                                  };
